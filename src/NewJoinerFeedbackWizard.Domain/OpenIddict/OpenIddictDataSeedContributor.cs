...
namespace NewJoinerFeedbackWizard.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("NewJoinerFeedbackWizard") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "NewJoinerFeedbackWizard", DisplayName = "NewJoinerFeedbackWizard API", Resources = { "NewJoinerFeedbackWizard" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Blazor Client
        var blazorClientId = configurationSection["NewJoinerFeedbackWizard_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["NewJoinerFeedbackWizard_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["NewJoinerFeedbackWizard_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["NewJoinerFeedbackWizard_Swagger:RootUrl"]?.TrimEnd('/');
